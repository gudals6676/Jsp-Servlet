    ...
    $.ajax({
    	...
    	success : function(data) {
    		if(data=="NO"){
    			...
    			location.href="loginFormajax.jsp"; //다시한번 메인화면으로 
...
function logoutFn() {
   ...
   $.ajax({
	   ...
	   //data :
		success : function(){  			
			location.href="loginFormajax.jsp";
			alert("로그아웃 성공쓰!!")
		},
		error : function(){alert("error");}
   });
...
<body>
  ...
  <div class="panel panel-default">
    ...
    <c:if test="${sessionScope.loginVO==null }"> <%-- request가아닌 session으로 getAttribute하기위해 sessionScope를 붙힘 --%>
    <form id="loginfrm" class="form-inline"  method="post">
      ...
      ${sessionScope.loginVO.user_name}님 방문을 환영합니다!!

			...
			<div class="panel-body">
				<form id="ufrm" class="form-horizontal" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" readonly="readonly" id="cwriter" readonly="readonly">								
						</div>
					</div>	
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<button type="button" class="btn btn-success btn-sm" onclick="closeFn()"><span class="glyphicon glyphicon-heart-empty"></span>닫아</button>
						</div>
					</div>
				</form>
